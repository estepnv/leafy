...
RSpec.describe Leafy::Mixin::ActiveRecord::Fields do
  ...
  shared_examples_for :fields_are_working_correctly do
    ...
    let(:instance) do
      FieldsHost.create(schema_host: host)
    end
  ...
  context 'sqlite3' do
    ...
    it_behaves_like :fields_are_working_correctly
  end
  ...
  context 'pg json/jsonb' do
    before do
      ...
      pool.with_connection do |conn|
        ...
        conn.create_table(:fields_hosts, force: true) do |t|
          t.belongs_to :schema_host, required: true
          t.text :leafy_data
          t.timestamps
        end
